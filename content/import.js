...
var menuIconImport = {
  ...
  onFinish: function() {
    ...
    if (!file) {
      ...
      var data = '/* ***** ' + iconSetName + ' ICON SET *****\n * ' +
                 'This file was generated by Menu Icons Plus for Firefox.\n * For help with modifying this file, view the custom icon set tutorial at:\n * ' +
